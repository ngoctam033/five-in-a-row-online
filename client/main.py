...
def main():
    ...
    root = tk.Tk()
    def start_game(username, opponent_name, current_turn):
        # Xóa giao diện login
        for widget in root.winfo_children():
            widget.destroy()
        app = ChessboardApp(root, ws_client=ws_client, username1=username, username2=opponent_name, current_turn=current_turn)
